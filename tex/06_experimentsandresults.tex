...
\begin{figure}[h]
	...
	\caption{Precision performance for point regression.\ToDo{Expand this caption so that it is self contained}}
...
\begin{table}[h]
  ...
  \begin{tabular}{l|l}
    ...
    \bottomrule
  \end{tabular}
  \caption{Coverage for different methods that regress the heatmap.\ToDo{Expand}}
...
\begin{table}[h]
  ...
  \begin{tabular}{l|l}
    ...
    \bottomrule
  \end{tabular}
  \caption{Overall performance comparison for different methods and our different approaches.\ToDo{Expaaaand. performance for what?}}
