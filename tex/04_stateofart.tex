...
This work come from a series of works that started with object detection on images using Convolutional Neural Networks~\fastrcnn. % \ToDo{Cite FastRCNN}
In a follow-up work, the same authors modify the architecture to make it differentiable, being able to train it end-to-end~\fasterrcnn. % \ToDo{Cite FasterRCNN}
...
%\ToDo{Link this work to your thesis (We also use deep metric.. to blabla..)}
