...
\usetikzlibrary{colorbrewer} % Nice colors
...
\input{tex/04_relatedwork.tex}
\input{tex/05_material.tex}
\input{tex/06_methods.tex}
\input{tex/07_experimentsandresults.tex}
